...
},{"./vue.common.dev.js":"../../node_modules/vue/dist/vue.common.dev.js"}],"utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createTest = exports.destroyVM = void 0;
...
var createTest = function createTest(comp) {
  var propsData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

  var constructor = _vue.default.extend(comp);
...
var expect = chai.expect; // 1\done 异步代码测试 哪的异步？

describe("Button", function () {
  var vm;
  afterEach(function (done) {
    (0, _utils.destroyVM)(vm);
    done();
  });
  it("create", function (done) {
    vm = (0, _utils.createTest)(_button.default, {
      type: "primary"
    });
    var el = vm.$el;
...
},{"./utils":"utils.js","../../src/components/button/button":"../../src/components/button/button.vue"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
